...
import hand from "../assets/image 4.png";
        ...
        <div className="contact-container">
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              emailjs
                .sendForm(
                  "service_pfcu4jd", // Replace with your EmailJS service ID
                  "template_8f109bj", // Replace with your EmailJS template ID
                  e.target,
                  "7T1RCHS45dD-R5JbL" // Replace with your EmailJS public key
                )
                .then(() => {
...
const MagicBento = ({
  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef} id="contact">
